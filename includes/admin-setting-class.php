...
class VbeeSettingsPage {
    ...
    public function id_callback(){
        ...
        <div style="width:100%;margin-bottom:10px">
            <input type="checkbox" <?php echo esc_attr($check) ?> <?php if(isset($this->options['id1']) &&  $this->options['id1'] == 'hn_female_ngochuyen_news_48k-thg') { echo 'checked'; } ?> id="id1" name="vbee-options[id1]" value="hn_female_ngochuyen_news_48k-thg" />
